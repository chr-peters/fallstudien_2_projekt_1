---
title: "Die lineare Regression mit ARMA-Fehlern"
output: pdf_document
---
...
for (provider in c("vodafone", "tmobile", "o2")){
  ...
  all_mse <- data.frame(
    ...
    # 5 Spalten (Anzahl Testsets der CV), nrow(grids[[provider]]) Zeilen 
...
Test auf Stationarität: AugmentedDickey-Fuller Test
